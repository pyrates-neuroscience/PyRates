...
# params = params.iloc[0, :].to_frame().T
# numpy backend grid-search
# results, param_map_, _ = grid_search(circuit_template="model_templates.jansen_rit.simple_jansenrit.JRC_delaycoupled",
