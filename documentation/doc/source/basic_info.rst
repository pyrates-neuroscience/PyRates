...
- `PyCoBi <https://github.com/pyrates-neuroscience/PyCoBi>`_ - a software for bifurcation analysis and parameter continuation. The user-supplied fortran files for this software can be directly generated by `PyRates` (see use examples).
