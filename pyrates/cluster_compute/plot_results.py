...
res_file = "/nobackup/spanien1/salomon/ClusterGridSearch/Montbrio/EIC/T10s_dt10us/Results/DefaultGrid_0/CGS_result_DefaultGrid_0.h5"
...
plot_avrg_peak_dist(results, parameters=parameters, tick_size=5)
