...
compute_dir = f'{home_dir}/Documents/ClusterGridSearch/CGS_MultipleGrids_test'
...
param_grid_0 = {'J_e': np.arange(8., 16., 2.), 'J_i': np.arange(2., 10., 2.)}
param_grid_1 = {'J_e': np.arange(16., 24., 2.), 'J_i': np.arange(10., 18., 2.)}
...
res_dir_0, grid_file_0 = cgs.compute_grid(param_grid_0)
res_dir_1, grid_file_1 = cgs.compute_grid(param_grid_1)
