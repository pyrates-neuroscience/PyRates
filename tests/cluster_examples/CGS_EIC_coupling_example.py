...
compute_dir = "/nobackup/spanien1/salomon/ClusterGridSearch/CGS_EIC_coupling_example"
...
for idx, C in enumerate(Cs):
    ...
    #     if not results[str(j_e][str(j_i)][str(k1)][str(k2)].isnull().any().any():
    #         _ = plot_psd(results[str(j_e][str(j_i)][str(k1)][str(k2)], tmin=cut_off, show=False)
